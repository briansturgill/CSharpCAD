...
internal class Intersecter
{
    ...
    private Segment SegmentNew(Vec2 start, Vec2 end)
    {
        return new Segment
        {
            Start = start,
    ...
    private void EventAdd(Node ev, Vec2 otherPt)
    {
    ...
    private int EventCompare(bool p1IsStart, Vec2 p11, Vec2 p12, bool p2IsStart, Vec2 p21, Vec2 p22)
    {
    ...
    {
        Vec2 a1 = ev1.Seg.Start;
        Vec2 a2 = ev1.Seg.End;
        Vec2 b1 = ev2.Seg.Start;
        Vec2 b2 = ev2.Seg.End;
    ...
    private Segment SegmentCopy(Vec2 start, Vec2 end, Segment seg)
    {
        return new Segment()
        {
            Start = start,
    ...
    private void EventUpdateEnd(Node ev, Vec2 end)
    {
    ...
    private void EventDivide(Node ev, Vec2 pt)
    {
    ...
    internal class RegionIntersecter : Intersecter
    {
        internal void AddRegion(List<Vec2> region)
        {
            // regions are a list of points:
            //  [ [0, 0], [100, 0], [50, 100] ]
            // you can add multiple regions before running calculate
            Vec2 pt1;
            Vec2 pt2 = region[region.Count - 1];
        ...
        internal RegionIntersecter() : base(true)
        {
        }
    }
    internal class SegmentIntersecter : Intersecter
    {
        internal void AddRegion(List<Vec2> region)
        {
            // regions are a list of points:
        ...
        internal SegmentIntersecter() : base(false)
        {
        }
    }
}