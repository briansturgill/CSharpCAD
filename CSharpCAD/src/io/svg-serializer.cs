...
public static partial class CSCAD
{
    ...
    private static class SVGSerializer
    {
        /**
         ...
         * </remarks>
         */
        public static string SerializeToSVG(Geometry g)
        {
        ...
        public static void ConvertToContinuousPath(StringBuilder svg, List<Vec2> path, Vec2 offset, string color)
        {
        ...
        public static void ConvertPath(StringBuilder svg, List<Vec2> points, Vec2 offset, bool isClosed)
        {
