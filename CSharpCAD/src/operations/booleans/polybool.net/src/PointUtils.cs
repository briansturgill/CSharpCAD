...
{
    internal static bool PointAboveOrOnLine(Point point, Point left, Point right)
    {
        return (right.X - left.X) * (point.Y - left.Y) - (right.Y - left.Y) * (point.X - left.X) >= -Epsilon.Eps;
    }

    internal static bool PointBetween(Point point, Point left, Point right)
    {
    ...
    internal static bool PointsSame(Point point1, Point point2)
    {
        return PointsSameX(point1, point2) && PointsSameY(point1, point2);
    }

    internal static int PointsCompare(Point point1, Point point2)
    {
    ...
    internal static bool PointsCollinear(Point pt1, Point pt2, Point pt3)
    {
        var dx1 = pt1.X - pt2.X;
        var dy1 = pt1.Y - pt2.Y;
        var dx2 = pt2.X - pt3.X;
    ...
    internal static IntersectionPoint LinesIntersect(Point a0, Point a1, Point b0, Point b1)
    {
